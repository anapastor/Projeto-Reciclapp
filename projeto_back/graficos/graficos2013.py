...
arquivo = r'C:\Users\kalle\Desktop\Importante\Programação\Trabalho 4 º Semstre\Projeto-Reciclapp\projeto_back\graficos\amlurbcoletatiposresiduos2013.csv'
...
# Filtrar dados onde 'TIPO DE RESIDUO' não é '(vazio)'
...
def gerar_grafico(mes):
    # (Todo o tratamento de dados permanece o mesmo)
