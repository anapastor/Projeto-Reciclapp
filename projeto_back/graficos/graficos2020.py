...
arquivo = r'C:\Users\kalle\Desktop\Importante\Programação\Trabalho 4 º Semstre\Projeto-Reciclapp\projeto_back\graficos\amlurbcoletatiposresiduos2020.csv'
...
def gerar_grafico(mes):
    ...
    print(f"Dados ordenados para o mês {mes}:\n", data_sorted[['TIPO DE RESIDUO', mes]])
